...
[原帖链接](https://linux.do/t/topic/1496548/1)

**作者：ICMP不可达喵**  
**时间：Jan 21, 2026 4:24 am**  
...
![image](https://cdn3.ldstatic.com/original/4X/c/2/9/c2921f5730bf3916dd1b087cd73c028c5f14cdf6.png)
...
![image](https://cdn3.ldstatic.com/original/4X/8/3/6/83686c70cc77a8d1a1341ef1a1d202f076d4cf6e.jpeg)
...
![image](https://cdn3.ldstatic.com/original/4X/0/5/c/05c58b33e77f5cf4c5ae804bd3630ff3324d9e08.png)
左侧可以选择严格程度，一般这个**Strictness Level**就是默认即可，当然你也可以看看历史情况；右侧你可以看到很多值，这个是标准家宽的情况，如果你是机房的话，那就是这样

![image](https://cdn3.ldstatic.com/original/4X/7/e/6/7e615278c31ebd81795453af2da73078b62805e7.png)
...
![image](https://cdn3.ldstatic.com/original/4X/9/c/9/9c98396a34823049f313e6f95f616bf0773fa39f.png)
![image](https://cdn3.ldstatic.com/original/4X/b/f/7/bf78f2c941dc9d1f69b7487d87eff3e5b8a9ad9e.png)
![image](https://cdn3.ldstatic.com/original/4X/8/2/0/820d24f2ea0dc176c068a5fa0e8f3ab4d5573760.png)
**TK佬：稳了，这波稳了，便宜又干净**

查查国外库

![image](https://cdn3.ldstatic.com/original/4X/0/7/f/07ff44edf2ae0bb2dd1d01495ca9069694260477.png)
![image](https://cdn3.ldstatic.com/original/4X/a/7/d/a7da20ac8cfffa00f94df24c8ad806ab1be8329d.png)
![image](https://cdn3.ldstatic.com/original/4X/3/5/6/356602123d9ca5f0daa7a9fc9c7ac3b23b7bc7f1.png)
![image](https://cdn3.ldstatic.com/original/4X/d/e/7/de7229900b823474eb0efe783afdeaba0d8e7a55.png)
**TK：稳了，又查出一个要风控的**
...
| --- | --- | --- | --- |
| 美国 | America/New_York (UTC-5) | Asia/Shanghai (UTC+8) | 矛盾，这可有13 小时时差 |
| 美国 | America/Los_Angeles (UTC-8) | Asia/Shanghai (UTC+8) | 矛盾，这可有16 小时时差 |
...
![image](https://cdn3.ldstatic.com/original/4X/7/c/5/7c5952bd521fed6c58a1fca210224e03b7131c95.png)
**防护手段**：
...
![image](https://cdn3.ldstatic.com/original/4X/c/0/4/c04a2aeeab6fc951327d0a32755a65bcfe76cf3c.png)
**代理用户配置不当时访问网页**

![image](https://cdn3.ldstatic.com/original/4X/0/a/9/0a996a930a3c2c895abd5dd54885b4a03294d03a.png)
![image](https://cdn3.ldstatic.com/original/4X/6/4/6/64622928cbf4fa2f3b51147d0a0a5b0c10264233.png)
...
![image](https://cdn3.ldstatic.com/original/4X/2/e/b/2eb30b3717502b48718b41d0b1e22c316be32b9f.png)
...
![image](https://cdn3.ldstatic.com/original/4X/b/8/6/b8665d07ea5c6272785bdacb8c60a541640ebf77.png)
...
![image](https://cdn3.ldstatic.com/original/4X/1/5/3/15317302e6b181850ff5660bd998c51780a14799.png)
哎，不是说WebRTC被设置成了走代理吗？是因为我的分流没设置好吗？我就开个全局吧

![image](https://cdn3.ldstatic.com/original/4X/1/9/4/1945d3c95a95fe14a4705c0778ab85ad765364b7.png)
...
![image](https://cdn3.ldstatic.com/original/4X/f/7/6/f76726e5e821abf53034574a852230088f657e24.png)
...
![image](https://cdn3.ldstatic.com/original/4X/2/c/a/2ca3e8c09922018b5244dffd9e783948498fc6a6.png)
...
![image](https://cdn3.ldstatic.com/original/4X/a/0/b/a0b911ab2425e1028aefe50bdbf7f92b0e7232b1.png)
...
![image](https://cdn3.ldstatic.com/original/4X/4/e/b/4eb0372ca7d9f097710b2bf0f4991fb8e4415677.png)
用户的DNS请求发送到ISP的DNS服务器(比如中国电信的DNS)，DNS服务器返回域名对应的IP地址，用户通过这个IP访问网站。这很正常，因为你本来就是中国电信的用户。

**使用代理但DNS没有泄露的情况**

![image](https://cdn3.ldstatic.com/original/4X/6/9/a/69a81b8a5cd5cf9fb93cdcb8ab2396925e1a87a9.png)
**使用代理但DNS泄露的情况**

![image](https://cdn3.ldstatic.com/original/4X/0/c/0/0c0eb859849f913c297dd8891dfb3febaf0ac264.png)
...
![image](https://cdn3.ldstatic.com/original/4X/4/c/c/4cc154214d413f9d3f45112cf6b500a0f224c560.png)
![image](https://cdn3.ldstatic.com/original/4X/5/4/7/54732deb3a2b88d23f5b0f312edc4faca2cd448f.png)
### 3.3 什么原因会出现DNS泄露？
...
![image](https://cdn3.ldstatic.com/original/4X/f/a/3/fa38e797488c33e79cba6ddb7ce67cd69191feae.png)
![image](https://cdn3.ldstatic.com/original/4X/1/c/2/1c2bcbc77843e9e784040879b64b56cc239b0527.png)> **不一致 ≠ 必然代理**，只是一个风险信号(中间设备/指纹库误判也可能导致不一致)
...
![image](https://cdn3.ldstatic.com/original/4X/f/f/c/ffcb141c719480376ae475e2957fe6dbeb065af1.png)
...
- **内核级别**的泄露
- 与用户客户端配置**无关**
- 理论上可以调节出口机器的系统指纹，但需要： - 修改内核参数（需要 root 权限） - 专业的网络知识 - 操作不当可能影响网络连接
...
![image](https://cdn3.ldstatic.com/original/4X/6/b/e/6be43575af4060af5d86a9fdfedd2b39f64b4eb9.png)
...
![image](https://cdn3.ldstatic.com/original/4X/4/e/d/4ed5022ffc180cb06cbd3713c252bb09655a7de7.png)
也许会有网络波动，但一般都在10ms以内

### 5.2 为什么有效

![image](https://cdn3.ldstatic.com/original/4X/4/d/9/4d9d89a0f1448874ec2a29189ed906bfc78b38c5.png)
...
![image](https://cdn3.ldstatic.com/original/4X/8/6/4/8642ea1e551254fb4a7e3b30ffd32f75d5d87bb4.png)
其他情况来看，几乎没有可能绕过。
...
![image](https://cdn3.ldstatic.com/original/4X/4/f/0/4f0aa4c87a9652668ac40403971586bc7ef06ac7.png)
## 6.浏览器指纹
...
![image](https://cdn3.ldstatic.com/original/4X/3/6/3/36329cdf58c10b3c82f6274d206df92bf80e4c23.png)
